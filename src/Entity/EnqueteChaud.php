...
/**
 * @ORM\Entity(repositoryClass=EnqueteChaudRepository::class)
 */
class EnqueteChaud
{
    /**
     ...
     * @ORM\Column(type="boolean")
     */
    private $doc_attestation_presence;

    /**
     * @ORM\Column(type="boolean")
     */
    private $doc_programme;

    /**
     * @ORM\Column(type="boolean")
     */
    private $doc_procedure_evaluation;

    /**
     * @ORM\Column(type="boolean")
     */
    private $doc_convocation;

    /**
     * @ORM\Column(type="boolean")
     */
    private $doc_reglement;

    /**
     * @ORM\Column(type="boolean")
     */
    private $doc_bail_location;
     ...
     * @ORM\Column(type="boolean")
     */
    private $doc_organigramme_of;

    /**
     * @ORM\Column(type="boolean")
     */
    private $doc_document_unique;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Planif::class, inversedBy="enqueteChauds")
     */
    private $planif;

    /**
     * @ORM\OneToOne(targetEntity=Stagiaire::class, inversedBy="enqueteChaud", cascade={"persist", "remove"})
     */
    private $stagiaire;
